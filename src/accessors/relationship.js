...
export class RelationshipAccessors extends PrimitiveAccessors {
  async get(target: PObject): any {
    const relationship = Reflect.getMetadata(Metadata.RELATIONSHIP, target, this.propertyKey);
    ...
    if (!relationship) {
      ...
      if (id) {
        ...
        Reflect.defineMetadata(Metadata.RELATIONSHIP, value, target, this.propertyKey);
        relationships.add(value);
      }
    }
    let value = Reflect.getMetadata(Metadata.RELATIONSHIP, target, this.propertyKey);
